 ...
 * )
 */
class Creators extends Text implements ConfigurableTargetInterface {
  ...
  public function defaultConfiguration() {
    return parent::defaultConfiguration() + [
      'paragraphs_type' => 'creator',
      'paragraph_field' => 'field_creator_name',
    ];
  }
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['paragraph_field'] = [
      ...
      '#options' => array(
        'field_creator_name' => 'Creator Name',
        'field_creator_role' => 'Creator Role'
      ),//$field_options,
    ];
